  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      ...
      it "creates a new Player" do
        expect {
          post :create, params: { player: FactoryBot.attributes_for(:player) }, session: valid_session
    ...
    context "with invalid params" do
      ...
      it "renders a JSON response with errors for the new player" do
        post :create, params: { player: FactoryBot.attributes_for(:game) }, session: valid_session
